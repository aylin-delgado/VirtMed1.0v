    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Pacientes</h6>
                <h1 class="mb-5">Consulta de pacientes registrados:</h1>
            </div>
...
$registros = mysqli_query($conexion, "select nombres,paterno,materno,NA,usuario
                      from registro") or
